...
//====================================
$(function () {
    var netState = onlinenetwork({
        "time":1000,
        "url":"https://www.o-banks.com/ping.php"

    })

    netState.onLineHandler(function(){

        window.localStorage.isNetNormal = true ;

    })

    netState.offLineHandler(function(){
        window.localStorage.isNetNormal = false ;
